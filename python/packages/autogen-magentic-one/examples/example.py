...
async def main(debug_dir: str) -> None:
    ...
    code_executor = LocalCommandLineCodeExecutor(work_dir=debug_dir)
    # Register agents.
    ...
    await LedgerOrchestrator.register(
        ...
        lambda: LedgerOrchestrator(
            agents=[web_surfer, coder, executor, file_surfer],
            model_client=client,
            max_rounds=50,
            max_stalls_before_replan = 100,
            max_time=25 * 60,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run MagenticOne example with debug directory.")
